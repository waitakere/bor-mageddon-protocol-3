...
export class Maja extends Phaser.Physics.Arcade.Sprite {
    ...
    private positionWeaponSprite() {
        ...
        // Catches both 'melee' and 'punch-2' depending on what is loaded in the atlas
        else if (currentAnimKey === 'melee' || currentAnimKey === 'punch-1' || currentAnimKey === 'punch-2') {
            if (currentFrameName.includes('000') || currentFrameName.includes('001')) {
                ...
                targetX += (110 * dirX); // Huge forward push
                targetY -= 150;          
